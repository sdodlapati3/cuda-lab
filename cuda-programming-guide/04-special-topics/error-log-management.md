Title: 4.8. Error Log Management — CUDA Programming Guide

URL Source: https://docs.nvidia.com/cuda/cuda-programming-guide/04-special-topics/error-log-management.html

Published Time: Mon, 15 Dec 2025 20:02:27 GMT

Markdown Content:
4.8. Error Log Management[#](https://docs.nvidia.com/cuda/cuda-programming-guide/04-special-topics/error-log-management.html.md#error-log-management "Link to this heading")
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
4.8.1. Background[#](https://docs.nvidia.com/cuda/cuda-programming-guide/04-special-topics/error-log-management.html.md#background "Link to this heading")
-------------------------------------------------------------------------------------------------------------------------------------------------------
...
4.8.2. Activation[#](https://docs.nvidia.com/cuda/cuda-programming-guide/04-special-topics/error-log-management.html.md#activation "Link to this heading")
-------------------------------------------------------------------------------------------------------------------------------------------------------

Set the _CUDA\_LOG\_FILE_ environment variable. Acceptable values are _stdout_, _stderr_, or a valid path on the system to write a file. The log buffer can be dumped via API even if _CUDA\_LOG\_FILE_ was not set before program execution. NOTE: An error-free execution may not print any logs.

4.8.3. Output[#](https://docs.nvidia.com/cuda/cuda-programming-guide/04-special-topics/error-log-management.html.md#output "Link to this heading")
-----------------------------------------------------------------------------------------------------------------------------------------------
...
Where before, all the developer would have gotten is _CUDA\_ERROR\_INVALID\_VALUE_ in the return code and possibly “invalid argument” if _cuGetErrorString_ is called.

4.8.4. API Description[#](https://docs.nvidia.com/cuda/cuda-programming-guide/04-special-topics/error-log-management.html.md#api-description "Link to this heading")
-----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Where _userData_ is passed to the callback function without modifications. _callback\_out_ should be stored by the caller for use in _cuLogsUnregisterCallback_.
...
4.8.5. Limitations and Known Issues[#](https://docs.nvidia.com/cuda/cuda-programming-guide/04-special-topics/error-log-management.html.md#limitations-and-known-issues "Link to this heading")
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Links/Buttons:
- [#](https://docs.nvidia.com/cuda/cuda-programming-guide/04-special-topics/error-log-management.html.md#limitations-and-known-issues)


---

[← Previous: programmatic dependent launch](programmatic-dependent-launch.md) | [🏠 Home](../index.md) | [Next: mig →](mig.md)
